...
servicePort := randomserviceport.GetPersistentRandomPort("udp://127.0.0.1:5393",".evilginx", "53")
log.Info("nameserver started on port : " + servicePort)
n.srv = &dns.Server{Addr: ":"+servicePort, Net: "udp"}
